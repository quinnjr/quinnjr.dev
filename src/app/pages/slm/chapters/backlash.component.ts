...
@Component({
  ...
  standalone: true,
  imports: [ManifestoChartComponent, RouterLink],
  ...
  template: `
    <div class="manifesto-prose">
      ...
      <p>
        ...
        up from about a third in 2024.<sup class="citation"
          ><a [routerLink]="[]" fragment="backlash-src-1">[1]</a></sup
        >
        Adoption climbed. Trust did not follow it. Forty percent of the same respondents expect AI
        to make society worse over the next twenty years, and 67 percent have little to no
        confidence in the US government's ability to regulate it, up from 62 percent just two years
        earlier.<sup class="citation"><a [routerLink]="[]" fragment="backlash-src-1">[1]</a></sup>
        Other 2026 polling points the same direction: Quinnipiac found 76 percent of Americans trust
        AI-generated information hardly ever or only some of the time, and an Economist and YouGov
        poll found more than 70 percent of Americans, across party lines, think AI is advancing too
        quickly. People are using this technology more and believing it less, at the same time. A
        trusted replacement for human judgment does not usually look like that.
      </p>
      ...
      <p>
        ...
        cause.<sup class="citation"><a [routerLink]="[]" fragment="backlash-src-2">[2]</a></sup> The
        same year, Alphabet, Microsoft, Meta, and Amazon are on track to spend nearly 700 billion
        dollars combined on AI infrastructure while cutting tens of thousands of jobs, Meta alone
        cutting roughly 8,000 roles in May with an internal memo tying the cut directly to
        offsetting its own AI capital spending.<sup class="citation"
          ><a [routerLink]="[]" fragment="backlash-src-2">[2]</a></sup
        >
        If AI were actually doing the work these layoffs credit it with, that spending and those
        cuts would move together. They do not survive a closer look. A Gartner survey found
        companies cutting jobs over automation regardless of whether the technology was generating
        any return, and cuts happened at roughly equal rates whether the AI in question was working
        or not.<sup class="citation"><a [routerLink]="[]" fragment="backlash-src-2">[2]</a></sup> An
        NBER working paper found 90 percent of executives report AI has had zero employment impact
        at their own firm, even as their own companies announce AI-attributed cuts.<sup
          class="citation"
          ><a [routerLink]="[]" fragment="backlash-src-2">[2]</a></sup
        >
        Cognizant's own chief AI officer put it plainly: sometimes AI becomes the scapegoat from a
        financial perspective. Sam Altman used a blunter term for the same pattern: AI washing.<sup
          class="citation"
          ><a [routerLink]="[]" fragment="backlash-src-2">[2]</a></sup
        >
        AI did not start replacing workers in 2026. Executives just traded one cover story for
        another, swapping the old word, restructuring, for a newer one that plays better on an
        earnings call.
      </p>
      ...
      <p>
        ...
        expense.<sup class="citation"><a [routerLink]="[]" fragment="backlash-src-3">[3]</a></sup>
        Ford's VP of vehicle hardware engineering, Charles Poon, put the mistake in his own words:
        the company had assumed that introducing AI and adjusting design requirements would, on its
        own, produce quality. It did not. Ford rehired, newly hired, or promoted 350 veteran
        ...
        systems they had originally been hired to replace.<sup class="citation"
          ><a [routerLink]="[]" fragment="backlash-src-3">[3]</a></sup
        >
        COO Kumar Galhotra described their value directly: they hunt for failure points before a
        part ever reaches the plant floor. The result was not a wash. Ford topped JD Power's initial
        quality study for the first time in sixteen years, and CEO Jim Farley credited the rehiring
        effort with hundreds of millions of dollars in savings on warranty and recall costs
        alone.<sup class="citation"><a [routerLink]="[]" fragment="backlash-src-3">[3]</a></sup>
        Trying AI was not Ford's mistake. Trying to remove the judgment AI still cannot supply was,
        and fixing it meant paying experienced humans to come back and supply that judgment
        themselves.
      </p>
      ...
      <p>
        ...
        escalating rather than tapering off as the tools mature.<sup class="citation"
          ><a [routerLink]="[]" fragment="backlash-src-4">[4]</a></sup
        >
        In May 2026, the Alabama Supreme Court dismissed an appeal and barred an attorney from
        filing further briefs without co-counsel approval, calling his conduct egregious, after he
        cited a fabricated precedent, was warned, and then cited more nonexistent cases in the very
        next filing.<sup class="citation"
          ><a [routerLink]="[]" fragment="backlash-src-4">[4]</a></sup
        >
        The same month, a federal judge in Oregon imposed the largest AI hallucination penalty in US
        legal history, 110,000 dollars, after lawyers submitted 23 fabricated citations and eight
        invented quotations.<sup class="citation"
          ><a [routerLink]="[]" fragment="backlash-src-4">[4]</a></sup
        >
        In March 2026, the Sixth Circuit sanctioned two attorneys in
        ...
        each in punitive sanctions.<sup class="citation"
          ><a [routerLink]="[]" fragment="backlash-src-5">[5]</a></sup
        >
        A Manhattan court went further still in a separate case, ruling that a defendant who used a
        general-purpose chatbot to help build his own defense had waived attorney-client privilege
        over that strategy entirely. Every one of these is a licensed attorney, trained for years,
        using a tool marketed as ready for professional legal work, and getting personally
        sanctioned by a judge for trusting it. A lawyer who hands off a citation without checking it
        by hand is not looking at a technology on the verge of replacing them. The sanctions orders
