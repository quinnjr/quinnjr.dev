...
export type BadgeVariant = 'primary' | 'secondary' | 'success' | 'warning' | 'danger' | 'info' | 'tavern' | 'gold' | 'parchment';
...
export class BadgeComponent {
  ...
  get badgeClasses(): string {
    ...
    const styleVariantClasses: Record<BadgeStyle, Record<BadgeVariant, string>> = {
      ...
      token: {
        primary: 'bg-gradient-to-b from-slate-400 to-slate-600 text-slate-900 border-2 border-slate-700 shadow-inner font-serif',
        secondary: 'bg-gradient-to-b from-purple-400 to-purple-600 text-purple-100 border-2 border-purple-800 shadow-inner font-serif',
        success: 'bg-gradient-to-b from-emerald-400 to-emerald-600 text-emerald-950 border-2 border-emerald-800 shadow-inner font-serif',
        warning: 'bg-gradient-to-b from-orange-400 to-orange-600 text-orange-950 border-2 border-orange-800 shadow-inner font-serif',
        danger: 'bg-gradient-to-b from-red-400 to-red-600 text-red-100 border-2 border-red-800 shadow-inner font-serif',
        info: 'bg-gradient-to-b from-cyan-400 to-cyan-600 text-cyan-950 border-2 border-cyan-800 shadow-inner font-serif',
        tavern: 'bg-gradient-to-b from-amber-600 to-amber-800 text-amber-100 border-2 border-amber-950 shadow-inner font-serif',
        ...
        parchment: 'bg-gradient-to-b from-amber-100 to-amber-300 text-amber-900 border-2 border-amber-600 shadow-inner font-serif',
      },
      seal: {
        primary: 'bg-gradient-radial from-blue-600 to-blue-800 text-blue-100 rounded-full shadow-lg shadow-blue-900/50 font-serif',
        secondary: 'bg-gradient-radial from-purple-600 to-purple-800 text-purple-100 rounded-full shadow-lg shadow-purple-900/50 font-serif',
        success: 'bg-gradient-radial from-green-600 to-green-800 text-green-100 rounded-full shadow-lg shadow-green-900/50 font-serif',
        warning: 'bg-gradient-radial from-orange-600 to-orange-800 text-orange-100 rounded-full shadow-lg shadow-orange-900/50 font-serif',
        danger: 'bg-gradient-radial from-red-700 to-red-900 text-red-100 rounded-full shadow-lg shadow-red-900/50 font-serif',
        info: 'bg-gradient-radial from-cyan-600 to-cyan-800 text-cyan-100 rounded-full shadow-lg shadow-cyan-900/50 font-serif',
        tavern: 'bg-gradient-radial from-amber-700 to-amber-900 text-amber-100 rounded-full shadow-lg shadow-amber-900/50 font-serif',
        ...
        parchment: 'bg-gradient-radial from-amber-200 to-amber-400 text-amber-900 rounded-full shadow-lg shadow-amber-600/50 font-serif',
      },
    };
