      ...
      <div class="container mx-auto px-4 py-8">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <p class="text-sm font-mono text-gray-900 dark:text-white break-all">{{ user.sub }}</p>
              </div>
              <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <p class="text-sm text-gray-600 dark:text-gray-400">Last Updated</p>
                <p class="text-sm font-mono text-gray-900 dark:text-white">{{ user.updated_at | date:'medium' }}</p>
              </div>
            </div>
          </div>
        }
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <a routerLink="/admin/articles/new" class="flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors">
              <i class="fas fa-plus"></i>
              <span>New Article</span>
            </a>
            <button class="flex items-center justify-center gap-2 px-4 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors">
              <i class="fas fa-folder-plus"></i>
              <span>New Project</span>
            </button>
            <button class="flex items-center justify-center gap-2 px-4 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors">
              <i class="fas fa-cog"></i>
              <span>Settings</span>
            </button>
            <button class="flex items-center justify-center gap-2 px-4 py-3 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors">
