          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
              ...
              <nav class="hidden md:flex gap-4 ml-8">
                <a routerLink="/admin" routerLinkActive="text-blue-600 dark:text-blue-400"
                ...
                <a routerLink="/admin/articles" routerLinkActive="text-blue-600 dark:text-blue-400"
                   class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  <i class="fas fa-newspaper mr-1"></i>Articles
                </a>
                <a routerLink="/admin/projects" routerLinkActive="text-blue-600 dark:text-blue-400"
                   class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  <i class="fas fa-project-diagram mr-1"></i>Projects
                </a>
                <a routerLink="/admin/settings" routerLinkActive="text-blue-600 dark:text-blue-400"
                   class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
            ...
            <div class="flex items-center gap-4">
              <a routerLink="/" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
